<%-- 
    Document   : novidades
    Created on : 27/04/2018, 20:43:11
    Author     : allan
--%>
...
<body ng-controller="novidadesController">
            ...
            <div class="col s12 m6 hide-on-small-only">
                <div class="card hoverable">
                    <div class="card-image">
                        ...
                        <a ng-controller="cartController"
                        ...
                        <a href="show.html" class="btn-floating halfway-fab waves-effect waves-light card-btn-detail"><i
        ...
        <div class="col s12 l4 m6" ng-repeat="(key, produto) in produtos | filter: pesquisa | filter: filtroValorMaximo | filter: filtroValorMinimo | orderBy: ordenar">
            <div class="card hoverable">
                <div class="card-image">
                    ...
                    <a ng-controller="cartController" href="javascript:void(0);" class="btn-floating halfway-fab waves-effect waves-light red tooltipped" ng-click="adicionarCarrinho(produto.id, produto.nome, produto.valor, produto.imagem)"><i
                ...
                <div class="card-content">
                    ...
                    <br>
                    <p style="height: 60px">{{produto.descricao}}</p>
                </div>
            </div>
        </div>
    </div>
